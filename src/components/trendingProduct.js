...
function TrendingProduct({navigation}){
    ...
    useEffect(()=>{
      fetch('https://api.bestbuy.com/beta/products/mostViewed(categoryId=abcat0107000)?apiKey=AbLMCxfXGS8vlNiAFQbYHUcM')
  ...
  return(
    <View style = {{marginTop:10}}>
        <View>
            <Text style = {{color:'black', fontWeight:'900', marginLeft:25, marginBottom:10, fontSize:16}}>Recommended</Text>
        </View>
        <FlatList
        horizontal
          data = {data.results}
